...
-- CONSTRUÇÃO DE CONSULTA PARA OBTENÇÃO DE RELATÓRIO NO SQL SERVER COM NOME, ANO/MÊS, QUANTIDADE VENDIDA E STATUS DA VENDA A PARTIR DA COMPARAÇÃO DO LIMITE DO 
-- VOLUME DE COMPRA
